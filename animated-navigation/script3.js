...
navElements = [nav1, nav2, nav3, nav4, nav5];
...
// It should "change" our menuBar class, and overlay (using the navAnimation). Use the overlay active trick to track whether the button has been clicked or not
function toggleNav() {
